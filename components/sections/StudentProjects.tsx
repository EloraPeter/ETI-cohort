      ...
      <Container>
        ...
        <div className="mt-16 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {studentProjects.map((project) => (
            ...
            >
              <div className="absolute inset-0 bg-signal-violet opacity-[0.12] transition-opacity duration-300 group-hover:opacity-25" />
              <div className="absolute inset-0 section-grid-bg opacity-40" aria-hidden="true" />
              <div className="absolute inset-x-0 bottom-0 p-5">
                <p className="font-mono text-xs uppercase tracking-wide text-violet-400">{project.tag}</p>
